...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a IvugeoEvolutionCoin address"));
    ...
    aboutAction->setToolTip(tr("Show information about IvugeoEvolutionCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for IvugeoEvolutionCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("IvugeoEvolutionCoin client") + QString(" ") + tr("[testnet]"));
...
{
    QString strTitle = tr("IvugeoEvolutionCoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid IvugeoEvolutionCoin address or malformed URI parameters."));
    }
