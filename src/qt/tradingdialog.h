...
private slots:
    ...
    void on_BuyIEC_clicked();
    void on_SellIECBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputIEC_textChanged(const QString &arg1);
    ...
    QString BuyIEC(QString OrderType, double Quantity, double Rate);
    QString SellIEC(QString OrderType, double Quantity, double Rate);
